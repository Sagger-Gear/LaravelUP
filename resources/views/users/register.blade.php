                ...
                @guest
                    <form method="POST" action="{{route('register')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"  id="inputEmail1" aria-describedby="invalidEmailFeedback" value="{{old('email')}}">
                        </div>
                        @error('email')
                        ...
                        @error('fullname')
                        <div id="invalidFullnameFeedback" class="invalid-feedback">
                            {{$message}}
                        </div>
                        @enderror
                        <div class="mb-3">
                        ...
                        @error('address')
                        <div id="invalidAddressFeedback" class="invalid-feedback">
                            {{$message}}
                        </div>
                        @enderror
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password_confirmation" class="form-control @error('password_confirmation')  is-invalid @enderror"  id="inputPasswordConfirmation" aria-describedby="invalidPasswordConfirmationFeedback">
                        </div>
