        ...
        <div class="row">
            ...
            <div class="col-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="fullname" class="form-control @error('fullname') is-invalid @enderror" id="inputFullname" placeholder="Фамилия Имя Отчество" aria-describedby="invalidInputFullname" value="{{ Auth::user()->address }}">
                        @error('fullname') <div id="invalidInputFullname" class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label for="inputAddress" class="form-label">Адрес:</label>
                        <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" id="inputAddress" placeholder="Ваш адрес" aria-describedby="invalidInputAddress" value="{{ Auth::user()->address }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password_confirmation" class="form-control @error('password') is-invalid @enderror" id="inputPasswordConfirmation" placeholder="Повтор пароля"></div>
